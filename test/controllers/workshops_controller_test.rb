...
class WorkshopsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create workshop" do
    assert_difference('Workshop.count') do
      post workshops_url, params: { workshop: { address: @workshop.address, locality_id: @workshop.locality_id, name: @workshop.name } }
    end
  ...
  test "should update workshop" do
    patch workshop_url(@workshop), params: { workshop: { address: @workshop.address, locality_id: @workshop.locality_id, name: @workshop.name } }
