...
class ProvincesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create province" do
    assert_difference('Province.count') do
      post provinces_url, params: { province: { country_id: @province.country_id, name: @province.name } }
    end
  ...
  test "should update province" do
    patch province_url(@province), params: { province: { country_id: @province.country_id, name: @province.name } }
